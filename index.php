      ...
      <div class="site-wrap" id="home-section">
          ...
          <div class="ftco-blocks-cover-1">
              <div class="ftco-cover-1 overlay" style="background-image: url('view/images/hero_1.jpg')">
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-lg-3">
                          ...
                          <!-- <p>
                              <a href="#" class="btn btn-primary custom-prev">previus</a>
                      ...
                      <div class="col-lg-9">
                          <div class="nonloop-block-13 owl-carousel">
                              <?php $i = 1;
                                foreach ($mobil->select_mobil() as $value) : ?>
                                  <?php if ($i < 2) : ?>
                                      <div class="item-1">
                                          <a href="#"><img src="image/<?= $value['foto'] ?>" alt="Image" class="img-fluid"></a>
                                          <div class="item-1-contents">
                                              <div class="text-center">
                                                  <h3><a href="#"><?= $value['merek'] ?></a></h3>
                                                  <div class="rating">
                          ...
                          <div class="row">
                              <div class="col-lg-4 mb-4 mb-lg-0">
                                  <div class="testimonial-2">
                                      ...
                                      <div class="d-flex v-card align-items-center">
                                          <img src="view/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
                              ...
                              <div class="col-lg-4 mb-4 mb-lg-0">
                                  <div class="testimonial-2">
                                      ...
                                      <div class="d-flex v-card align-items-center">
                                          <img src="view/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
                              ...
                              <div class="col-lg-4 mb-4 mb-lg-0">
                                  <div class="testimonial-2">
                                      ...
                                      <div class="d-flex v-card align-items-center">
                                          <img src="view/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
                          ...
                          <div class="row">
                              <div class="col-lg-4 col-md-6 mb-4">
                                  <div class="post-entry-1 h-100">
                                      <a href="single.html">
                                          <img src="view/images/post_1.jpg" alt="Image" class="img-fluid">
                                      </a>
